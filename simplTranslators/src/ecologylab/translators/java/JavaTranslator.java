...
public class JavaTranslator extends AbstractCodeTranslator implements JavaTranslationConstants
{
	...
	static
	{
	  InputStream stgIStream =
	      JavaTranslator.class.getResourceAsStream("/codeTranslators/javaCodeTranslator.stg");
	  InputStreamReader isr = new InputStreamReader(stgIStream, Charset.forName("UTF-8"));
