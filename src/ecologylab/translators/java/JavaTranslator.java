...
public class JavaTranslator implements JavaTranslationConstants
{
			...
			throws IOException
	{
		...
		Date date = new Date();
		appendable.append("/**\n*  " + inputClass.getDecribedClassSimpleName()
			...
			throws IOException
	{
		...
		String className = inputClass.getDecribedClassSimpleName();
	...
	{
		appendDefaultConstructor(inputClass.getDecribedClassSimpleName(), appendable);
	}
	 ...
	 * @throws IOException
	 */
	private void appendAnnotations(Appendable appendable, ClassDescriptor classDesc, String tabSpacing)
			throws IOException
	{
	 ...
	 * @throws IOException
	 */
	private void appendGetters(FieldDescriptor fieldDescriptor, Appendable appendable)
			throws IOException
	{
		String javaType = fieldDescriptor.getJavaType();
		if (javaType == null)
	 ...
	 * @throws IOException
	 */
	private void appendSetters(FieldDescriptor fieldDescriptor, Appendable appendable)
			throws IOException
	{
		String javaType = fieldDescriptor.getJavaType();
		if (javaType == null)
			...
			throws IOException
	{
		...
		appendAnnotations(appendable, inputClass, "");
		...
		appendable.append(SPACE);
		appendable.append(inputClass.getDecribedClassSimpleName());
		appendGenericTypeVariables(appendable, inputClass);
		appendable.append(SPACE);
		appendable.append(INHERITANCE_OPERATOR);
		appendable.append(SPACE);
		appendable.append(genericSuperclass.getDecribedClassSimpleName());
