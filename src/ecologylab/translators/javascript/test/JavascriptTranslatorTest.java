...
public class JavascriptTranslatorTest {
	public static void main(String args[]) throws IOException, SIMPLTranslationException
	{
		...
		SimplTypesScope ts = new SimplTypesScope();
		ts = SimplTypesScope.get("somegame",Player.class, Bank.class,Computer.class,Human.class,Item.class,Move.class, Movements.class,Player.class, ReferToSelf.class);
