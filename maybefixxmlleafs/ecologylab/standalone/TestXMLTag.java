...
public @xml_tag("doobie-doobie-dah_dooooooo") class TestXMLTag extends ElementState
{
    ...
    public static void main(String[] args) throws XmlTranslationException
    {
        ...
        System.out.println(ElementState.translateFromXMLString(test.translateToXML(),
                TranslationSpace.get("test", "test", classes)).translateToXML());
        
        System.out.println(taggies.translateToXML());
        System.out.println(ElementState.translateFromXMLString(taggies.translateToXML(),
                TranslationSpace.get("test", "test", classes)).translateToXML());
