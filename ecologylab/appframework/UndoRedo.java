...
public class UndoRedo<O extends MixedInitiativeOp> extends Debug
{
	 ...
	 */
	protected final PrefInt					undoLevels					= Pref.usePrefInt(UNDO_LEVELS,
																													DEFAULT_UNDO_LEVELS);
	...
	/**
	 * Pushes an Operation onto the undo stack. Clears the redo stack because a new operation has
	 * taken place.
	 * 
	 * @param op
	 */
	...
	/**
	 * Pushes an Operation onto the Undo stack. If too many operations, removes oldest and adds op.
	 * 
	 * @param op
	 */
	...
	/**
	 * Pops an Operation from the Undo stack. If empty, returns null.
	 * 
	 * @return
	 */
	...
	/**
	 * Peak an Operation from the Undo stack. If empty, returns null.
	 * 
	 * @return
	 */
	...
	/**
	 * Pops an Operation from the Redo stack. If empty, then returns null.
	 * 
	 * @return
	 */
