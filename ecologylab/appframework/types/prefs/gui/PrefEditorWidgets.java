...
public class PrefEditorWidgets extends Debug implements ChangeListener
{
    ...
    {
        LinkedHashMap<String,ObjectRegistry<JComponent>> categoryMap = this.jCatComponentsMap.get(mp.getCategory());
    ...
    public void updatePrefsFromWidgets()
    {
    	...
    	for (String cat : metaPrefSet.getCategories())
    	{
    		for (MetaPref mp : metaPrefSet.getMetaPrefListByCategory(cat))
    		{
                ...
                //TODO probably take this code out; now setValue will notify all PrefChangedListeners that are registered with it.
