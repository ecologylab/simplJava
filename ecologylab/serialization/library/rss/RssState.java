...
public class RssState extends ElementState
{
	...
	public static final ParsedURL	NYT_TECH_FEED				= ParsedURL
																												.getAbsolute("http://www.nytimes.com/services/xml/rss/nyt/Technology.xml");

	public static final ParsedURL	CNN_TOP_FEED				= ParsedURL
																												.getAbsolute("http://rss.cnn.com/rss/cnn_topstories.rss");

	public static final ParsedURL	BBC_FRONT_FEED			= ParsedURL
																												.getAbsolute("http://news.bbc.co.uk/rss/newsonline_world_edition/front_page/rss.xml");

	public static final ParsedURL	ABC_SPORTS_FEED			= ParsedURL
																												.getAbsolute("http://my.abcnews.go.com/rsspublic/sports_rss20.xml");

	public static final ParsedURL	FLICKR_FEED					= ParsedURL
																												.getAbsolute("http://www.flickr.com/services/feeds/photos_public.gne?format=rss_200&tags=sunset");

	public static final ParsedURL	DELICIOUS_FEED			= ParsedURL
																												.getAbsolute("http://del.icio.us/rss/andruid/");

	public static final String		ABC_EXAMPLE					= "<rss xmlns:media=\"http://search.yahoo.com/mrss/\" xmlns:feedburner=\"http://rssnamespace.org/feedburner/ext/1.0\" version=\"2.0\">\r\n"
																												+ "<channel> \r\n"
																												+ "\r\n"
																												+ "<item>\r\n"
																												+ "		        \r\n"
	...
	public static final String		FEEDBURNER_EXAMPlE	= "<rss xmlns:feedburner=\"http://rssnamespace.org/feedburner/ext/1.0\" version=\"2.0\">\r\n"
																												+ "<channel>\r\n"
																												+ "<title>CNN.com</title>\r\n"
																												+ "\r\n"
																												+ "<item>\r\n"
	...
	public static final String		FLICKR_EXAMPLE			= "<rss version=\"2.0\"\r\n"
	...
	public static final String		ITEM_EXAMPLE				= "	<channel>\r\n"
																												+ "			<foo>Fire-Works</foo>\r\n"
																												+ "		<item>\r\n"
																												+ "			<title>Fire-Works</title>\r\n"
																												+ "			<link>http://www.flickr.com/photos/meemz/2161548299/</link>\r\n"
	...
	public static final String		NABEEL_TEST					= "<rss version=\"1\">"
																												+ "<channel>"
	...
	private static void doMain()
	{
		try
		{
			...
			RssState rssState = (RssState) RssTranslations.get().deserialize(feedPURL, Format.XML);
			// RssState rssState = (RssState) ElementState.translateFromXMLCharSequence(FLICKR_EXAMPLE,
			// RssTranslations.get());
