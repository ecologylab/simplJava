...
/**
 * An ElementState XML tree node that supports an Vector of
 * children (as well as whatever else you add to it).
 * <p/>
 * In general, one should use ArrayListState for this kind of functionality,
 * but, in some cases, there may  be concurrency issues, in which case,
 * this more expensive class will be required.
 * 
 * @author andruid
 */
