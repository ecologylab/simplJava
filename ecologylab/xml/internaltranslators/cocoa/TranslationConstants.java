...
public class TranslationConstants
{
	...
	public static final String	GET_TRANSLATIONSCOPE								= "getTranslationScope";

	public static final String	IF_TRANSLATIONTION_SCOPE_NULL				= "if (translationtionScope == null)";
