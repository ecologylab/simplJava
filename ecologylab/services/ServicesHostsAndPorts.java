 ...
 * People using our software elsewhere may wish to change these.
 * People in our lab need to talk to each other about changes here.
 *
 * @author andruid
 */
public interface ServicesHostsAndPorts
{
	...
	//	publicstatic final String LOGGING_HOST = "128.194.138.51"; // unix.cs.tamu.edu
	
//	public static final String LOGGING_HOST = "128.194.147.58";  // CSDLL server IP address
	
	public static final String 	LOGGING_HOST		= NetTools.localHost();

	public static final int		LOGGING_PORT 		= 10000;

	public static final int 	BROWSER_SERVER_PORT	= 10001;
