...
public class NIOServerIOThread extends NIONetworking implements ServerConstants
{
	static NIOServerIOThread getInstance(int portNumber, InetAddress[] hostAddresses,
			NIOServerProcessor sAP, TranslationScope requestTranslationSpace, Scope<?> objectRegistry,
	...
	protected NIOServerIOThread(int portNumber, InetAddress[] hostAddresses, NIOServerProcessor sAP,
	...
	private void construct(InetAddress[] newHostAddresses, NIOServerProcessor newFrontend,
