...
/**
 * Interface that contains the list of constant Strings used for Authentication messages. Implement this interface if
 * your class uses Login or Logout.
 * 
...
public interface AuthMessages
{
	...
	/**
	 * Indicates that login failed because either the username was not found, or because the password did not match a
	 * username.
	 */
