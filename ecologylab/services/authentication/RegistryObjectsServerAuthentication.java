...
public interface RegistryObjectsServerAuthentication
{
    ...
    /**
     * Indicates a HashMap\<String\>\<ServerToClientConnectionAuthentication\> object; used to map usernames to ServerToClientConnectionAuthentication objects that represent their connections. Generally used to ensure that each username is logged in only once.
     */
    public static final String AUTHENTICATED_CLIENTS = "authenticatedClients";

    /**
     * Indicates an AuthenticationList object that contains all the usernames and passwords for the server.
     */
