 ...
 * @author andruid
 */
public class LoggingMemoryMapped extends Logging implements Runnable,
        ServicesHostsAndPorts
{
    ...
    public LoggingMemoryMapped(NameSpace nameSpace)
    {
        this(nameSpace, null);
    }

    public LoggingMemoryMapped(NameSpace nameSpace, String logFileName)
    {
        ...
        case LOG_TO_FILE:
            ...
            else
            {
                ...
                else
                {
                    ...
                    new File(logDir, logFileName).delete();
...
//        if (finished)
  //      {
    //        debug("The log file is finished; no more actions may be written.");
//
  //      }
    //    else
      //  {
...
//        }
    ...
    protected class FileLogWriter extends LogWriter
    {
                ...
                throws IOException
        {
            ...
            LoggingMemoryMapped.this.debugA("Logging to " + logFile + " " + buffy);
        }
    ...
    protected class NetworkLogWriter extends LogWriter
    {
        ...
        NetworkLogWriter(ServicesClient loggingClient) throws IOException
        {
            if (loggingClient == null)
                throw new IOException(
                        "Can't log to Network with null loggingClient.");
            this.loggingClient = loggingClient;
            LoggingMemoryMapped.this.debug("Logging to service via connection: "
                    + loggingClient);
        }
        ...
        void writePrologue(SendPrologue sendPrologue)
        {
            ...
            LoggingMemoryMapped.this.debug("Logging: Sending Prologue userID:" + uid);
        ...
        void writeEpilogueAndClose(SendEpilogue sendEpilogue)
        {
            LoggingMemoryMapped.this.debug("Logging: Sending Epilogue " + LOG_CLOSING);
