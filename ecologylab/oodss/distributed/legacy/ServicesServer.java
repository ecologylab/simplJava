...
import ecologylab.oodss.distributed.impl.ServerEvent;
 ...
 * via ecologylab.serialization (using reflection). Performs services based on the messages, and acknowledges with responses. <p/>
...
public class ServicesServer extends ServicesServerBase
{
    ...
    /**
     * 
     * See ecologylab.oodss.ServicesServerBase#shutdownAndNotify(java.util.Collection)
     */
