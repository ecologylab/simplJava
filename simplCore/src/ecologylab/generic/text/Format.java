...
/**
 * <code>Format</code> is an abstract base class for formatting
 ...
 * no separator in between, and in this case the <code>parseObject</code>
 ...
 * <code>Format</code>-- <code>DateFormat</code>,
 * <code>MessageFormat</code>, and <code>NumberFormat</code>--for
 ...
 * are used, for example, by <code>MessageFormat</code>. Subclasses often
 * also provide additional <code>format</code> methods for specific input
 * types as well as <code>parse</code> methods for specific result types. Any
 ...
 * <ol>
 * <li> <code>getInstance</code> for getting a useful format object
...
public abstract class Format implements Serializable, Cloneable
{
	 ...
	 * <code>Field</code>. It is up to each <code>Format</code>
	 * implementation to define what the legal values are for each attribute in
	 * the <code>AttributedCharacterIterator</code>, but typically the
	...
	public Object parseObject(String source) throws ParseException
	{
		...
		if (pos.getIndex() == 0)
		{
			throw new ParseException("Format.parseObject(String) failed", pos
					.getErrorIndex());
		}
		return result;
	}
	...
	/**
	 * Returns an AttributedCharacterIterator with the String <code>string</code>
	 * and additional key/value pair <code>key</code>, <code>value</code>.
	 * 
	 * @param string
	 *           String to create AttributedCharacterIterator from
	 * @param key
	 ...
	 * <code>Format.formatToCharacterIterator</code> and as field identifiers
	 * in <code>FieldPosition</code>.
	 * 
	 * @since 1.4
	 */
	...
	interface FieldDelegate
	{
		 ...
		 * @param buffer
		 *           Contains current formatted value, receiver should NOT modify
		 *           it.
		 */
