 ...
 */
@simpl_tag("site")
public class BasicSite extends ElementState implements IMappable<String>, Site
{
  ...
  /**
   * Minimum time to wait between downloads for this domain Specified in seconds
   */
  @simpl_scalar
  protected float   minDownloadInterval;
  ...
  @simpl_scalar
  protected boolean ignoreSemanticBoost;
  ...
  /**
   * @param minDownloadInterval
   *          the minDownloadInterval to set
   */
